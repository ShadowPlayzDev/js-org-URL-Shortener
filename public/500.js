module.exports = async (req, res) => {
  ...
  const htmlContent = `
    ...
    <head>
        ...
        <title>ShortURL - HTTP Error 500</title>
        ...
        <script>
            ...
            function animatePercentage(start, end, duration, element) {
                ...
                function step(currentTime) {
                    ...
                    if (progress < 1) {
                        currentPercentage = Math.min(end, Math.floor(start + progress * (end - start)));
            ...
            // No need for window.onload since the script is at the end of the body.
            // We can just call it directly.
            animatePercentage(0, 100, animationDuration, percentageCounter);
        </script>
    </body>
    </html>
  `;
